        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          {allCases.map((caseStudy) => (
            <Link
              ...
              className="group block relative overflow-hidden rounded-2xl bg-white border border-gray-200 hover:border-accent-500 transition-all duration-200 hover:shadow-xl"
            >
              {/* Thumbnail */}
